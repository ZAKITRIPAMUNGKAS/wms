...
import { ref } from 'vue';
import { PhNotePencil, PhTrash, PhUser, PhPhone, PhEnvelope, PhMapPin } from "@phosphor-icons/vue";
        ...
        <ResponsiveTable :headers="['Nama Customer', 'Kontak', 'Email', 'Alamat']" :items="customers.data">
            ...
            <template #pagination>
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4 w-full">
                    <p class="text-xs text-slate-400 font-bold uppercase tracking-widest">Showing {{ customers.from || 0 }}-{{ customers.to || 0 }} of {{ customers.total }}</p>
                ...
                <div class="p-6 md:p-8 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                        <div class="col-span-2">
                            <label class="block text-xs font-bold text-slate-500 mb-2 uppercase tracking-widest ml-1">Nama Customer</label>
                            <input type="text" v-model="form.nama" required class="input-base font-bold" placeholder="Nama lengkap customer...">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="email" v-model="form.email" class="input-base font-bold" placeholder="customer@email.com">
                        </div>
                        <div class="col-span-2">
